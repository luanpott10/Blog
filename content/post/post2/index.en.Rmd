...
image:
  ...
  placement: 1
  preview_only: true
subtitle: 'Welcome. In this post, I am going to show you how you may create point maps, linear regression and logistic regression utilizing base R tools and tidymodels workflow'
summary: 'Welcome. In this post, I am going to show you how you may create point maps, linear regression and logistic regression utilizing base R tools and tidymodels workflow'
...
## URL link of data from data collcetion and remote sensing on GitHub <https://github.com/luanpott10/Class>

## You will nedd the raw file <https://raw.githubusercontent.com/luanpott10/Class/main/data_crops.csv>
